...
driver = webdriver.Chrome('C:/Users/student/chromedriver')
...
a = soup.select(f'#wrap > div.container > div.content > div > div > div.calendar.fc.fc-unthemed.fc-ltr > div.fc-view-container > div > table > tbody > tr > td > div > div > div:nth-child(1) > div.fc-content-skeleton > table > tbody > tr:nth-child(1) > td:nth-child(5)')[0].text
if a == '':
    print('미퇴실!!')
